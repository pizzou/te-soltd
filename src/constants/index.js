...
export const AppText={
   ...
   aboutMeDescripion:'TE-SO specializes in technological,Leadership and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc',
   Skills:'Skills & ',
   Experties:'Experties',
   ...
   Contact:'Contact ',
   Us:'Us',
   copywriteText:'Copyright by TE-SO @2023'
